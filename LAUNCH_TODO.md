...
- [ ] Create dedicated helpdesk / support email (e.g. support@strdr.app or hello@strdr.app) — current placeholder is andybiesiadecki@gmail.com; replace before launch in PRIVACY_POLICY.md, APP_STORE_COPY.md, and App Store Connect contact info
